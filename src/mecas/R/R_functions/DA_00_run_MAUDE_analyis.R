...
run_MAUDE_analysis <- function(cfg){
  ...
  # Run MAUDE
  #-----------------------------------------------------------------------------
  if (isTRUE(cfg$debug$MAUDE)){log_info("Before run_prepare_data_for_MAUDE | R memory: {sprintf('%.2f GB', memory_used_gb())} | RSS: {sprintf('%.2f GB', memory_rss_gb())}")}
  ...
  if (isTRUE(cfg$debug$MAUDE)){log_info("After run_prepare_data_for_MAUDE | R memory: {sprintf('%.2f GB', memory_used_gb())} | RSS: {sprintf('%.2f GB', memory_rss_gb())}")}
  ...
  if (isTRUE(cfg$debug$MAUDE)){log_info("After run_MAUDE | R memory: {sprintf('%.2f GB', memory_used_gb())} | RSS: {sprintf('%.2f GB', memory_rss_gb())}")}
  ...
  if (isTRUE(cfg$debug$MAUDE)){log_info("After export | R memory: {sprintf('%.2f GB', memory_used_gb())} | RSS: {sprintf('%.2f GB', memory_rss_gb())}")}  
  #-----------------------------------------------------------------------------
  ...
  if (isTRUE(cfg$debug$MAUDE)){log_info("After run_consensus call | R memory: {sprintf('%.2f GB', memory_used_gb())} | RSS: {sprintf('%.2f GB', memory_rss_gb())}")}
