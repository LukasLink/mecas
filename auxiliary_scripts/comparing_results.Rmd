...
p <- qq_rectangle_plot(
  ...
  title = "PA bcwithqc vs align rank comparison",
  FDR_thresh = 0.05,
  rank_gamma = 1, # rank_gamma = 1 is linear scalling
  grey_frac = 0.2,
  save_fpath = file.path(nico_dir, "PA_linear.png")
)
p <- qq_rectangle_plot(
  align_rds_fpath = dca_align_mean_rds_fpath,
  bcwithqc_rds_fpath = dca_bcwithqc_mean_rds_fpath,
  ...
  rank_gamma = 1, # rank_gamma = 1 is linear scalling
  grey_frac = 0.2,
  save_fpath = file.path(nico_dir, "DCA_linear.png")
)
p <- qq_rectangle_plot(
  align_rds_fpath = gal_align_mean_rds_fpath,
  bcwithqc_rds_fpath = gal_bcwithqc_mean_rds_fpath,
  ...
  rank_gamma = 1, # rank_gamma = 1 is linear scalling
  grey_frac = 0.2,
  save_fpath = file.path(nico_dir, "GAL_linear.png")
)
