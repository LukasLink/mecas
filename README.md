...
| `QC-filter`           | Run FASTQ quality-control filtering.                                                                                         |
| `bcwithqc-preprocess` | Prepare input files for bcwithqc.                                                                                            |
| `bcwithqc-count`      | Run bcwithqc counting.                                                                                                       |
| `reads-per-umi-count` | Read the BAM files generated by bcwithqc and create one RDS count file for each paired or unpaired input file.               |
